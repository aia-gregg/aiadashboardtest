    ...
    <Table>
        ...
        <TableBody>
            {transactions.map((t: Transaction) => {
                ...
                return (
                    <TableRow key={t.id} className={`${isDebit || amount[0] === '-' ? 'bg-[#110000]' : 'bg-[#061100]'} !over:bg-none !border-b-[#202020]`}>
                        ...
                        <TableCell className="pl-2 pr-10 capitalize min-w-24 text-gray-400">
                            {t.paymentChannel}
                        </TableCell>
